  ...
  return (
    ...
    >
      ...
      >
          ...
          >
            ...
            <Typography
              ...
              sx={{
                ...
                lineHeight: { xs: '1.25', sm: '1.15', md: '1.2', lg: '0.8' },
                fontWeight: 700,
        ...
        >
          Zulikat Wuraola House, 362 Herbert Macaulay Way, Victoria Island,
          Lagos. |{' '}
          <span style={{ fontStyle: 'italic' }}>+1-800-456-478-23</span>
        </Typography>
      </Flex>
      ...
      >
        ...
        <Box
          ...
          sx={{
            ...
            gridRow: { xs: '10 / 12', sm: '10 / 12', md: '3 / 5' },
            width: '100%',
            height: '100%',
          }}
          src={'/yaba/yaba_2.png'}
        ...
        <Box
          ...
          sx={{
            ...
            gridRow: { xs: '14 / 16', sm: '14 / 16', md: '1 / 2' },
            width: '100%',
            height: '100%',
          }}
          src={'/yaba/yaba_4.png'}
        ...
        <Box
          ...
          sx={{
            gridColumn: { xs: '1 / 3', sm: '1 / 3', md: '2 / 3' },
            gridRow: { xs: '16 / 18', sm: '16 / 18', md: '2 / 3' },
            width: '100%',
            height: '100%',
          }}
          src={'/yaba/yaba_5.png'}
        ...
        <Box
          ...
          sx={{
            gridColumn: { xs: '1 / 3', sm: '1 / 3', md: '1 / 3' },
            gridRow: { xs: '12 / 14', sm: '12 / 14', md: '5 / 7' },
            width: '100%',
            height: '100%',
          }}
          src={'/yaba/yaba_7.png'}
        ...
        <Box
          component={'img'}
          sx={{
            gridColumn: { xs: '1 / 3', sm: '1 / 3', md: '3 / 4' },
            gridRow: { xs: '7 / 10', sm: '7 / 10', md: '7 / 9' },
            width: '100%',
            height: '100%',
          }}
          src={'/yaba/yaba_9.png'}
      ...
      <Flex justifyContent={'center'}>
        <ContainedButton
          sx={{
            ...
            fontWeight: 500,
            fontSize: { xs: '1.2rem', sm: '1.2rem', md: '1.2rem', lg: '1.8rem' },
